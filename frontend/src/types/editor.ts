...
import { z } from 'zod';
import { FileKindSchema } from '@/api/schemas';
...
/** What the CodeMirror hook needs to build and keep a view in step. */
export type UseCodemirrorOptionsType = CodeEditorPropsType;
